"""
Source: https://code.google.com/p/python-ttk/wiki/ttkWizard
"""
...
def demo():
    ...
    page0 = tk.Label(wizard.page_container(0), text='Page 1')
    page1 = tk.Label(wizard.page_container(1), text='Page 2')
    page2 = tk.Label(wizard.page_container(2), text='Page 3')

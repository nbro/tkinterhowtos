...
Note: The ToolTip will not work correctly for Frame widgets.
Frame widgets' ToolTips will appear in the upper-left corner of the screen.
Please notify me of other widgets it does not work for
"""
...
class ToolTip(Toplevel):
    ...
    """
    Provides a ToolTip widget for tk.
    To apply a ToolTip to any tk widget, simply pass the widget to the
    ToolTip constructor
    """

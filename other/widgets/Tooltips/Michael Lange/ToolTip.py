...
Email: klappnase@freakmail.de
Source: http://tkinter.unpythonic.net/wiki/ToolTip

Description:

The ToolTip class provides a flexible tooltip widget for tk;
it is based on IDLE's ToolTip
...
textvariable :  if set to an instance of tk.StringVar() the variable's value will be used as text for the widget
...
create_contents() : creates the contents of the tooltip window (by default a tk.Label)
"""
